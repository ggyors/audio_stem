...
class UnetAudioStemmer(nn.Module):
    ...
    def __init__(self):
        ...
        self.down1 = DownConvBlock(in_channels=1, out_channels=16)
        self.down2 = DownConvBlock(in_channels=16, out_channels=32)
        self.down3 = DownConvBlock(in_channels=32, out_channels=64)
        ...
        self.final_conv = nn.Conv2d(in_channels=16,
                                    out_channels=1,
                                    kernel_size=1,
                                    )
